# features
* include most popular C/C++ libraries, eg. grpc, protobuf, boost, abseil, folly, proxygen, mvfst, zstd, curl, openssl ...
...
clear && bazel build --config=gcc_aarch64_linux_musl //...
...
## mem leak detect
Use sanitizers (ASan/LSan) via `--config=sanitize`.
