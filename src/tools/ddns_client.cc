...
int main(int argc, char* argv[]) {
  ...
  
  {
    ...
    while (true) {
      ...
      auto route53IPv6s = getCurrentRoute53Records(
          route53Client, hostedZoneId, DOMAIN_NAME);
      ...
      if (needsUpdate) {
        std::cout << "Updating Route53 with primary IPv6: " 
                  << primaryIPv6 << std::endl;
