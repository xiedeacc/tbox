...
#ifndef TBOX_COMMON_PROTO_PLUGIN_PB_CODE_GENERATOR_H_
#define TBOX_COMMON_PROTO_PLUGIN_PB_CODE_GENERATOR_H_
...
#endif  // TBOX_COMMON_PROTO_PLUGIN_PB_CODE_GENERATOR_H_
