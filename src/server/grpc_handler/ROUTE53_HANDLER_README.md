...
auto stub = tbox::proto::MEGAService::NewStub(channel);

// Create an A record update request
tbox::proto::Route53Request request;
request.set_op(tbox::proto::OpCode::OP_ROUTE53_UPDATE_A_RECORD);
...
// Send the request
tbox::proto::Route53Response response;
...
request.set_op(tbox::proto::OpCode::OP_ROUTE53_UPDATE_CNAME_RECORD);
