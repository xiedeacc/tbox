...
tbox::proto::EC2InstanceRequest request;
request.set_op(tbox::proto::OpCode::OP_EC2_START);
request.set_instance_id("i-1234567890abcdef0");
request.set_region("us-west-2");

// Send the request
tbox::proto::EC2InstanceResponse response;
...
request.set_op(tbox::proto::OpCode::OP_EC2_STOP);
