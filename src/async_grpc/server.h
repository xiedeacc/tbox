...
class Server {
 protected:
  ...
  struct Options {
    ...
    int max_receive_message_size = tbox::common::MAX_GRPC_MSG_SIZE;
    int max_send_message_size = tbox::common::MAX_GRPC_MSG_SIZE;
    bool enable_tracing = false;
    double tracing_sampler_probability =
        tbox::common::TRACING_SAMPLER_PROBALITITY;
