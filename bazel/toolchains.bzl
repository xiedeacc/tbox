            ...
            "x86_64": {
                "linux": [
                    ...
                    },
                    {
                        ...
                        "strip_prefix": "clang18.1.8-linux-x86_64_toolchain",
                        "sha256sum": "be64a29251dd2b7ae6e8e783f99ab395b4bf2a75f98d8a6e03bf855e9d811434",
                        "sysroot": "/root/src/software/toolchains/linux-x86_64-musl_sysroot",
                        "tool_names": {
                            "ar": "llvm-ar",
                            "as": "llvm-as",
                            "c++": "clang++",
            ...
            "aarch64": {
                "linux": [
                    ...
                    },
                    {
                        ...
                        "compiler": "gcc",
                        "triple": "aarch64-unknown-linux-gnu",
                        "url": "https://rgit.xiedeacc.com/files/gcc14.2.0-aarch64-unknown-linux-gnu.tar.gz",
                        ...
                        "lib_directories": [
                            ...
                            "aarch64-unknown-linux-gnu/lib64",
                        ],
                        "sysroot_lib_directories": [
                            "lib",
                            "usr/lib",
