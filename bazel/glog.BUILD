load("@tbox//bazel:common.bzl", "dict_union", "template_rule")
...
template_rule(
    ...
    substitutions = select({
        "@tbox//bazel:not_cross_compiling_on_windows": windows_config,
        "@tbox//bazel:cross_compiling_for_windows": mingw64_config,
...
template_rule(
    ...
    substitutions = select({
        "@tbox//bazel:not_cross_compiling_on_windows": {
            ...
            "#define HAVE___ATTRIBUTE__": "/* #undef HAVE___ATTRIBUTE__ */",
            "#define HAVE___BUILTIN_EXPECT 1": "/* #undef HAVE___BUILTIN_EXPECT */",
