load("@tbox//bazel:common.bzl", "GLOBAL_COPTS", "GLOBAL_LOCAL_DEFINES", "extract_symbols", "template_rule")
...
cc_library(
    ...
    srcs = glob(
        ...
        "@tbox//bazel:osx_x86_64": ["src/zone.c"],
        "@tbox//bazel:osx_aarch64": ["src/zone.c"],
        "//conditions:default": [],
    }),
    hdrs = [
        ":jemalloc_defs_h",
